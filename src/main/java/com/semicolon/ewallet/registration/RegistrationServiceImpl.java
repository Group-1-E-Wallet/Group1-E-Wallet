...
public class RegistrationServiceImpl implements RegistrationService{
    ...
    public String tokenConfirmation(
        ...
        var token = tokenService.getConfirmationToken(
